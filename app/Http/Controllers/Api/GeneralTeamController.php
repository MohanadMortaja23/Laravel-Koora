...
class GeneralTeamController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->merge([
            'user_id' => $user->id,
            'conversation_id'=> Conversation::where('team_type' , GeneralTeam::class)->first()->id
        ]);
        ...
        event( new GeneralChannel($user , $request->message ,  $input['image'] ) );
